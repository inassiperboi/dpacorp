...
<head>
    ...
    <link rel="preconnect" href="public/images/hero/logo.png">
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('admin.company-profile.edit') }}"
           class="nav-item {{ request()->routeIs('admin.company-profile*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.about.history') }}"
           class="nav-item {{ request()->routeIs('admin.about.history*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.about.legal') }}"
           class="nav-item {{ request()->routeIs('admin.about.legal*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.about.vision-mission') }}"
           class="nav-item {{ request()->routeIs('admin.about.vision*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.contacts.index') }}"
           class="nav-item {{ request()->routeIs('admin.contacts*') ? 'active' : '' }}">
            ...
            @php
                $unread = \App\Models\ContactMessage::where(
                    'is_read',
                    false
                )->count();
            @endphp
    ...
    <div class="sidebar-footer">
        ...
        <form action="{{ route('cp.logout') }}"
            ...
            <button type="button"
                    class="btn-logout"
                    onclick="confirmLogout(this.closest('form'))">
